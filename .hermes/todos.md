...
- [ ] pages-404-fix. (Investigar) Rotas de pagina /pt-BR, /en-US, /es-ES retornam 404 (NEXT_NOT_FOUND) mesmo renderizando o conteudo. Causa provavel: middleware de locale / tratamento de [locale] + vercel.json. Validar no browser; se persistir, checar middleware de locale + vercel.json (framework nextjs). (pendente)
