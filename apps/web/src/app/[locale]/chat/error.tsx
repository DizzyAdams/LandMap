    ...
    <div className='relative flex min-h-screen flex-col items-center justify-center px-6'>
      ...
      <div className='mt-8 flex items-center gap-3'>
        <button
          type='button'
          onClick={reset}
          className='glow-primary inline-flex h-10 items-center rounded-lg bg-[var(--primary)] px-5 text-sm font-medium text-white transition hover:bg-[var(--primary-bright)]'
        >
          Tentar novamente
        </button>
        <Link
          href={`/${locale}`}
          className='inline-flex h-10 items-center rounded-lg border border-[var(--border-lovable)] px-5 text-sm text-[var(--foreground)] transition hover:border-[var(--primary)]/50'
        >
          Voltar ao início
        </Link>
      </div>
