    ...
    <main className="min-h-screen grid-bg px-6 py-16">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 overflow-x-auto">
          <div className="min-w-[640px] space-y-3 rounded-xl border border-neutral-800 bg-neutral-900/40 p-4">
            {Array.from({ length: 7 }).map((_, i) => (
              <div key={i} className="h-6 animate-pulse rounded bg-neutral-800/70" />
            ))}
          </div>
        </div>
      </div>
