    ...
    <div className="rounded-xl border border-[var(--border)] bg-[var(--card)]/40 p-4">
      ...
      <div className="flex items-center justify-between lg:hidden">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-[var(--border)] px-4 py-2 text-sm text-[var(--foreground)] transition hover:border-[var(--border)] hover:text-[var(--foreground)]"
        >
      ...
      >
        ...
        <div className="lg:col-span-5 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <span
              className="hidden items-center gap-1 text-[11px] text-[var(--muted-foreground)] sm:inline-flex"
              aria-hidden="true"
            >
              Pressione <kbd className="rounded border border-[var(--border)] px-1">/</kbd> ou{' '}
