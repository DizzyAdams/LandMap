    ...
    <div className="inline-flex items-center gap-3 rounded-lg border border-[var(--primary)]900/50 bg-emerald-950/20 px-3 py-1.5 text-[var(--foreground)] backdrop-blur-md">
      <div className="flex items-center gap-1.5">
        <span className="relative flex h-2 w-2">
          ...
          <span className="relative inline-flex h-2 w-2 animate-pulse rounded-full bg-[var(--primary)]" />
        </span>
        <span className="text-[11px] uppercase tracking-wide text-[var(--primary)]">{t('live.label')}</span>
      </div>
