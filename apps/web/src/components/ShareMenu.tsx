  ...
  return (
    <div className={`relative inline-block ${className}`}>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--border-lovable)] bg-[var(--card)] px-3 py-1.5 text-xs text-[var(--foreground)] transition hover:border-[var(--primary)]/60 hover:text-[var(--primary)]"
        aria-label="Share"
      >
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 z-50 mt-2 w-48 rounded-2xl border border-[var(--border-lovable)] bg-[var(--card)] p-2 shadow-xl">
            <button
              onClick={() => shareVia('whatsapp')}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-xs text-[var(--foreground)] transition hover:bg-[var(--muted-lovable)] hover:text-[var(--primary)]"
            >
            ...
            <div className="my-1 border-t border-[var(--border-lovable)]" />
            <button
              onClick={copyLink}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-xs text-[var(--foreground)] transition hover:bg-[var(--muted-lovable)] hover:text-[var(--primary)]"
            >
