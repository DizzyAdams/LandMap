  ...
  return (
    <div className={`relative inline-block ${className}`}>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg border border-neutral-800 bg-neutral-900/40 px-3 py-1.5 text-xs text-neutral-300 transition hover:border-neutral-500 hover:text-white"
        aria-label="Share"
      >
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 z-50 mt-2 w-48 rounded-xl border border-neutral-800 bg-neutral-900 p-2 shadow-xl">
            <button
              onClick={() => shareVia('whatsapp')}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-xs text-neutral-300 transition hover:bg-neutral-800 hover:text-white"
            >
            ...
            <button
              ...
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-xs text-neutral-300 transition hover:bg-neutral-800 hover:text-white"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 4l-10 8L2 4"/></svg>
              Email
            </button>
