...
export function WhatsNewBanner() {
  ...
  return (
    <div className="relative z-50 border-b border-amber-300/20 bg-[#0a0a0a]/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center gap-3 px-6 py-2 text-xs">
        <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-amber-300/30 bg-amber-300/10 px-2 py-0.5 font-medium text-amber-200">
