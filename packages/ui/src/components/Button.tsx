...
export const Button = ({ variant = 'primary', size = 'md', className, ...props }: ButtonProps) => {
  const styles = {
    ...
    primary:
      'bg-gradient-to-r from-[var(--primary)] to-[var(--primary)]/70 text-[#050505] shadow-[0_0_0_1px_color-mix(in_srgb,var(--primary)_15%,transparent),0_8px_30px_-12px_color-mix(in_srgb,var(--primary)_50%,transparent)] hover:-translate-y-px hover:shadow-[0_0_0_1px_color-mix(in_srgb,var(--primary)_45%,transparent),0_14px_44px_-12px_color-mix(in_srgb,var(--primary)_65%,transparent)]',
