      ...
      {open && (
        ...
        >
          ...
          >
            {(title || description) && (
              <div className="flex items-start justify-between gap-4 border-b border-[var(--border)] px-5 py-4">
                ...
                <button
                  ...
                  onClick={onClose}
                  aria-label="Close"
                  className="flex-none rounded-md p-1 text-[var(--muted-foreground)] outline-none transition hover:bg-[var(--accent)] hover:text-[var(--foreground)] focus-visible:shadow-[var(--ring)]"
                >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 text-sm text-[var(--foreground)]">{children}</div>
