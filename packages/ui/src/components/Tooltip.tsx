      ...
      <span ref={ref} className={cn('relative inline-flex', className)}>
        ...
        {open && (
          <span
            ...
            id={id}
            className={cn(
              'pointer-events-none absolute z-50 max-w-xs rounded-lg border border-[var(--border)] bg-[var(--card)] px-2.5 py-1.5 text-xs leading-snug text-[var(--muted-foreground)] backdrop-blur-md',
